...
class PetFinderCamera extends StatefulWidget {
  @override
  _PetFinderCameraState createState() => _PetFinderCameraState();
}

class _PetFinderCameraState extends State<PetFinderCamera> {
  ...
  Future<void> takePicture() async {
    ...
    try {
      ...
      // Return the captured image to the previous screen
